...
bool __fastcall CLightOmni::CheckVisibilityByBounds(_IN CObjectScene& rObject) _GET
{
	if (MeasureDistance3((Float3&)rObject.Position(), (Float3&)m_Position) < (m_fRange + rObject.BoundsRadius())) { return TRUE; }
	return FALSE;
}

bool __fastcall CLightOmni::CheckVisibilityByBounds(_IN Float3& rPosition, _IN float fRadius) _GET
{
	if (MeasureDistance3(rPosition, (Float3&)m_Position) < (m_fRange + fRadius)) { return TRUE; }
	return FALSE;
}

void __fastcall CLightOmni::BoundsUpdate()
{
	m_fBoundsRadius	= m_fRange;
}

void __fastcall CLightOmni::ApplyProjectionShadow() const
{
...
void __fastcall CLightOmni::ApplyProjection3D() const
{
	//Prepare renderer
...
void __fastcall CLightOmni::Update()
{
...
void __fastcall CLightOmni::ViewVolumeUpdate()
{
